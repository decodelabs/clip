...
[![GitHub Workflow Status](https://img.shields.io/github/workflow/status/decodelabs/clip/Integrate)](https://github.com/string|int|floatdecodelabs/clip/actions/workflows/integrate.yml)
